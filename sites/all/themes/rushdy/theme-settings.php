 ...
 */
function rushdy_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['rushdy_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('rushdy sample setting'),
  '#default_value' => theme_get_setting('rushdy_example'),
